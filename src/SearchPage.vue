                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex items-center gap-4 px-4 py-3 bg-gray-50 rounded-lg border border-gray-300">
                            <div class="flex items-center gap-2">
                                ...
                                />
                                <label for="keywords-or-search" class="text-sm text-gray-700 whitespace-nowrap cursor-pointer">
                                    Keywords Or
                                </label>
                            </div>
                            <div class="flex items-center gap-2">
                                <input
                                    ...
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                                />
                                <label for="keywords-and-search" class="text-sm text-gray-700 whitespace-nowrap cursor-pointer">
                                    Keywords And
                                </label>
                            </div>
                        </div>
